...
_HERO = f"""<section class="hero">
  <div class="hero-inner">
    ...
    <div class="hero-actions">
      ...
      <a class="hero-btn" href="/gyeonggi/guri/reservation/">예약 안내 보기</a>
    </div>
    <ul class="hero-stats">
...
<p>구리시 출장마사지를 찾는 분들은 보통 현재 위치에서 가까운 방문 가능 지역을 먼저 확인합니다. 구리시는 면적이 크지는 않지만 갈매동, 인창동, 교문동, 수택동, 동구동의 생활권 차이가 뚜렷합니다. 구리역과 구리전통시장 주변은 중심 상권 성격이 강하고, 수택동과 장자호수공원 주변은 주거지와 상권이 함께 연결됩니다. 갈매동은 신도시형 주거 생활권이고, 동구동과 인창동은 동구릉역과 인창동 주거지, 사노동 인접권을 함께 설명해야 합니다. 그래서 이 사이트는 "구리 전지역 가능"만 반복하는 방식 대신, 대표동과 역세권, 생활권을 나누어 안내하는 구조로 만들었습니다. 예약 전에는 방문 가능 지역, 예약 가능 시간, 추가 이동비, 결제 방식, 취소 기준, 개인정보 처리 기준을 함께 확인하시는 것이 좋습니다. 자세한 절차는 <a href="/gyeonggi/guri/reservation/">구리시 방문 예약 안내</a>에서 단계별로 정리했습니다.</p>
</section>

<section id="difference">
<h2>갈매동·인창동·교문동·수택동 생활권 차이</h2>
<p>같은 구리시라도 동마다 주거 형태와 생활 리듬이 다릅니다. 갈매동은 구리 북쪽의 <a href="/gyeonggi/guri/area/galmae-newtown/">갈매신도시 생활권</a>으로 아파트 단지와 갈매역 접근성이 중심이고, 인창동은 구리역과 동구릉역 사이의 주거 생활권입니다. 교문동은 구리시청과 교문사거리, 아차산 인접권을 아우르고, 수택동은 구리역·돌다리사거리·장자호수공원역·토평 인접권이 함께 연결되는 구리시에서 가장 넓은 생활권입니다. 동구동은 동구릉역과 사노동, 동구릉 인접권을 함께 안내합니다. 동네별 분위기가 다른 만큼 방문 시간대나 차량 이동 기준에 대한 안내도 조금씩 달라집니다. 거주하시거나 머무시는 동의 특징은 <a href="/gyeonggi/guri/region/">구리시 지역별 안내</a>에서 한눈에 비교할 수 있습니다.</p>
</section>
...
<li><a href="/gyeonggi/guri/donggu-dong/">동구동</a></li>
<li><a href="/gyeonggi/guri/inchang-dong/">인창동</a></li>
<li><a href="/gyeonggi/guri/gyomun-dong/">교문동</a></li>
<li><a href="/gyeonggi/guri/sutaek-dong/">수택동</a></li>
</ul>
<p>수택동은 구리시 안에서도 검색 의도가 가장 넓은 대표 생활권이라, <a href="/gyeonggi/guri/sutaek-dong/">수택동 방문 관리 안내</a>에서 돌다리사거리, 구리전통시장, 장자호수공원역, 토평동 인접권을 함께 확인하실 수 있습니다.</p>
</section>
...
<ul class="card-grid">
<li><a href="/gyeonggi/guri/station/guri-station/">구리역</a></li>
<li><a href="/gyeonggi/guri/station/galmae-station/">갈매역</a></li>
<li><a href="/gyeonggi/guri/station/donggureung-station/">동구릉역</a></li>
<li><a href="/gyeonggi/guri/station/jangja-lake-park-station/">장자호수공원역</a></li>
<li><a href="/gyeonggi/guri/station/dasan-nearby-area/">다산역 인접</a></li>
<li><a href="/gyeonggi/guri/station/donong-nearby-area/">도농역 인접</a></li>
</ul>
<p>역과 생활권을 함께 확인하고 싶다면 <a href="/gyeonggi/guri/area/">구리시 생활권 안내</a>에서 구리역·구리전통시장, 돌다리사거리·수택동, 장자호수공원·토평 같은 거점 기준 안내를 참고해 주세요.</p>
</section>

<section id="check">
<h2>구리시 홈타이 예약 전 확인사항</h2>
<p>구리시 홈타이는 자택, 숙소, 사무실 인근에서 예약 가능 여부를 확인한 뒤 이용하는 방문형 관리 서비스입니다. 원활한 방문을 위해 정확한 도로명 주소, 공동현관 출입 방법, 매트를 펼 수 있는 공간, 조용한 환경을 미리 확인해 주시면 좋습니다. 구리역과 수택동처럼 접근성이 좋은 지역도 있지만, 동구동 사노동 방면이나 아천동 일부는 시간대에 따라 차량 이동 기준이 달라질 수 있습니다. 방문 전 준비사항은 <a href="/gyeonggi/guri/guide/">이용 전 확인사항</a>에, 출장마사지와 홈타이의 차이와 이용 기준은 <a href="/gyeonggi/guri/hometai-guide/">홈타이 이용 가이드</a>에 정리했습니다.</p>
</section>

<section id="dedupe">
<h2>구리시 페이지 중복 방지 운영 기준</h2>
<p>이 사이트는 검색 순위를 노린 대량 저가치 페이지를 만들지 않습니다. 교문1·2동, 수택1·2·3동을 각각 만들지 않고 대표동으로 통합하며, 사노동·토평동·아천동은 단독 얇은 페이지 대신 생활권 페이지에서 보조 설명합니다. 구리역 페이지와 인창동 페이지, 장자호수공원역 페이지와 수택동 페이지는 같은 본문을 쓰지 않고 역세권 기준과 지역 기준으로 역할을 나눕니다. 지역명만 바꿔 같은 문장을 반복하는 방식은 사용하지 않으며, 비용과 절차는 화면에 적힌 그대로 상담에서 안내합니다. 운영 주체와 콘텐츠 작성·검수 방식은 <a href="/gyeonggi/guri/about/">사이트 소개</a>에서 공개합니다.</p>
</section>

<section id="how-to-use">
<h2>구리시 출장마사지 사이트 이용 방법</h2>
<p>먼저 거주하시거나 머무시는 위치를 대표동, 역세권, 생활권 중 익숙한 기준으로 찾으신 뒤, 해당 페이지에서 방문 가능 지역과 예약 전 확인사항을 확인하세요. 그다음 <a href="/gyeonggi/guri/reservation/">예약 안내</a>에서 가능 시간과 결제·취소 기준을 보시고, 전화로 위치와 희망 시간을 알려주시면 가능 여부를 바로 확인해 드립니다. 어느 기준으로 들어오셔도 예약 절차와 비용 기준은 동일하니, 본인에게 편한 기준으로 보시면 됩니다.</p>
</section>
